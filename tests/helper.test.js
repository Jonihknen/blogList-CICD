...
describe('most likes', () => {
  ...
  test('when list has only one blog, equals the likes of that', () => {
    ...
    expect(result).toEqual(oneMostLikes)
  })
...
describe('author with most blogs', () => {
  ...
  test('when list has one blog', () => {
    ...
    expect(result).toEqual(mostBlogsWithOne)
  })
  test('of empty list is empty list', () => {
...
describe('author with most likes', () => {
  ...
  test('when list has one blog', () => {
    ...
    expect(result).toEqual(mostLikesWithOne)
  })
